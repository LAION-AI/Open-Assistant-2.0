...
- **submit personal data about other people** — do not paste other people's
  ...
  uploaded traces. If it is unavoidable, use the on-device redaction feature
  first. You are the one who decides what leaves your machine;
...
## 4. Your endpoints and third-party services
...
**5.1 Licence to operate the Service.** You grant LAION a non-exclusive,
...
**5.2 Licence to publish — only with separate consent.** Publication of your
...
**5.3 What you promise when you consent.** That the content is yours to license
— that you wrote it (or hold the rights), and that you have not knowingly
included other people's personal data or confidential material belonging to
someone else, such as an employer.

**5.4 Withdrawal.** Withdrawing consent removes your data from all future
...
**5.5 Model outputs.** Responses come from third-party models. We make no claim
